 ...
 * @CreateDate: 
 * @LastEditor: 
 * @LastEditTime: 2022-10-20 16:19:51
-->
<template>
    <div class="container">
        <div :id="uuid" class="tree-wraper" :style="style">
            <zg-tree :default-checked-keys="defaultCheckedKeys" ref="tree" v-slot="{ ...scope }" :style="innerStyle"
                v-bind="config" checkOnClickNode :data="rangeData" @collapseChange="collapseChange"
