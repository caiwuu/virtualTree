 ...
 * @CreateDate:
 * @LastEditor:
 * @LastEditTime: 2022-10-31 17:51:45
-->
<template>
  <div class="container">
    ...
    <div class="demo-container">
      <virtual-tree :key="key" :default-checked-keys="defaultCheckedKeys" ref="virtualTree" v-slot="{ row }" :height="400" :width="800" :row-height="24" :data="data" :level-indent="20"
        ...
        <span v-if="showOperateBtn">
          ...
          <span class="operateBtn" @click.stop="add(row)"><svg t="1666277092401" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4445" width="16"
              height="16">
              <path
          ...
          <span class="operateBtn" @click.stop="remove(row)"><svg t="1666277005829" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4215" width="16"
              height="16">
              <path
...
export default {
  ...
  methods: {
    mock () {
      ...
      this.data3 = genTreeData(10, 100, 400)
      this.gening = false
    },
    setDataSize (l) {
      this.l = l
