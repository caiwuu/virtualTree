...
<template>
  <div class="container">
    ...
    <div class="demo-container">
      <virtual-tree :key="key" :default-checked-keys="defaultCheckedKeys" ref="virtualTree" v-slot="{ row }" :height="600" :width="800" :row-height="24" :data="data" :level-indent="20"
...
export default {
  ...
  methods: {
    mock () {
      ...
      this.data3 = genTreeData(10, 100, 100)
      this.gening = false
